...
public class C03_Actions extends TestBase {
    ...
    public void test01() {
        ...
        Set<String> hendleSeti=driver.getWindowHandles();

        String ikinciSayfaWHDegeri="";

        for (String each:hendleSeti
             ) {
       ...
       // WebElement yaziElemnti=driver.findElement(By.tagName("h1"));

        //String actuelYazi=yaziElemnti.getText();
        //String expectedYzi="Elemental Selenium";
        //Assert.assertEquals(expectedYzi,actualYazi);
