...
public class C03_windowHandles {
    ...
    public void test01() {
        ...
        WebElement sayfadakiYazi = driver.findElement(By.xpath("//h3"));
        String sayfadakiyaziStr = sayfadakiYazi.getText();
        String arananYazi = "Opening a new window";
        Assert.assertTrue(sayfadakiyaziStr.contains(arananYazi));
